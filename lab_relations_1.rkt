...
;;-------------------------------------------------------------------------------
;; Name: Jacob Gerega
;; Pledge: I pledge my honor that I haved abided by the Stevens Honor System.
;;-------------------------------------------------------------------------------
...
(define (relates-to v R)
  (if (null? R)
      '()
      (if (eq? v (car (car R)))
          (make-set(append (cdr(car R)) (relates-to v (cdr R))))
          (relates-to v (cdr R))
      )
)
  )
